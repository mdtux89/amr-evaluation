...
def get_best_match(len_inst1, len_inst2, attribute1, relation1,attribute2, relation2,prefix1, prefix2):
    """
    ...
    (candidate_mappings, weight_dict) = compute_pool(len_inst1, len_inst2, attribute1, relation1,
                                                     attribute2, relation2,
                                                     prefix1, prefix2)
...
def compute_pool(len_inst1, len_inst2, attribute1, relation1,
                 attribute2, relation2,
                 prefix1, prefix2):
    """
...
def smart_init_mapping(candidate_mapping):
    return random_init_mapping(candidate_mapping)
    # """
...
def main(arguments):
    ...
    while True:
        ...
        (best_mapping, best_match_num) = get_best_match(len(instance1), len(instance2), attributes1, relation1,
